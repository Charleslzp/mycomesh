...
// V5 binds every paid route to the session at activation. Individual receipts
// are relayed later and never require another browser wallet signature.
export const settlementV5Abi = parseAbi([
  "function stablecoin() view returns (address)",
  "function rewardToken() view returns (address)",
  "function treasury() view returns (address)",
  "function governance() view returns (address)",
  ...
  "function sessionInfo(bytes32 sessionId) view returns ((address consumer,address provider,address relay,address relaySigner,address pool,address sessionKey,bytes32 channel,uint64 pricingVersion,bytes32 pricingHash,uint64 openedAt,uint64 expiresAt,uint64 closeRequestedAt,uint256 maxAmount,uint256 spent,uint256 nextSequence,bool closed))",
  "function settleSignedReceipt(((bytes32,bytes32,bytes32,bytes32,bytes32,bytes32,uint64,bytes32,address,address,address,address,uint256,uint256,uint256,uint256,uint256),(bytes32,bytes32,address,address,uint256,uint256),bytes,bytes,bytes) input)",
  "function settleSignedBatch(((bytes32,bytes32,bytes32,bytes32,bytes32,bytes32,uint64,bytes32,address,address,address,address,uint256,uint256,uint256,uint256,uint256),(bytes32,bytes32,address,address,uint256,uint256),bytes,bytes,bytes)[] inputs)",
  "event Deposited(address indexed account, uint256 requestedAmount, uint256 receivedAmount)",
