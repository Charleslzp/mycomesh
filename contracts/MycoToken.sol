...
contract MycoToken {
    string public name = "MycoMesh Token";
    ...
    function burnFromTreasury(address treasury, uint256 amount) external onlyMinter {
        require(balanceOf[treasury] >= amount, "balance");
